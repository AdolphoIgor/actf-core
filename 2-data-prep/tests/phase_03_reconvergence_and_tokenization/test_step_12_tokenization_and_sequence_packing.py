...
from scripts.phase_03_reconvergence_and_tokenization.step_12_tokenization_and_sequence_packing import TokenizerAndPacker
...
def test_tokenizer_and_packer_sequence_packing():
    ...
    input_table = pa.Table.from_pydict({
        ...
        "preserve_whitespace": [False, True]
    })
